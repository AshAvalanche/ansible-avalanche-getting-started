...
machines = {
  validator01: { ip: "192.168.1.11", memory: 1024, cpus: 1 },
  validator02: { ip: "192.168.1.12", memory: 1024, cpus: 1 },
  validator03: { ip: "192.168.1.13", memory: 1024, cpus: 1 },
  validator04: { ip: "192.168.1.14", memory: 1024, cpus: 1 },
  validator05: { ip: "192.168.1.15", memory: 1024, cpus: 1 },
}
